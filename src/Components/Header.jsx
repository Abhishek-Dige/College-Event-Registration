                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <NavLink end to="/dance" className="dropdown-item">
                                            Dance
                                        </NavLink>
                                        <NavLink end to="/music" className="dropdown-item">
                                            Music
                                        </NavLink>
                                        <NavLink end to="/drama" className="dropdown-item">
                                            Drama
                                        </NavLink>
                                        <NavLink end to="/fine-arts" className="dropdown-item">
                                            Fine Arts
                                        </NavLink>
                                        <NavLink end to="/debate" className="dropdown-item">
                                            Debate
                                        </NavLink>
                                        <NavLink end to="/coding" className="dropdown-item">
                                            Coding
                                        </NavLink>
                            ...
                            <div className="mx-2 mt-2 mt-lg-0">
                                <button className="btn btn-success mx-2" data-bs-toggle="modal" data-bs-target="#loginModal">Login</button>
                                <button className="btn btn-danger mx-2" data-bs-toggle="modal" data-bs-target="#registerModal">Register</button>
                            </div>
                        </div>
                    </div>
                </nav>
